import { Image, Button, Avatar, Descriptions, Carousel } from 'antd';
            ...
            <div className={cx('pet-detail-left')}>
                <div className={cx('pet-detail-info')}>
                    ...
                    <div className={cx('pet-detail-field')}>
                        ...
                        <div className={cx('value', petData.status ? 'in-stock' : 'out-of-stock')}>
                            {petData.status ? 'Còn hàng' : 'Hết hàng'}
                        </div>
                    </div>
                    <div className={cx('pet-detail-field')}>
                        <div className={cx('label')}>Hành động:</div>
                        <div className={cx('value')}>
                            <Button danger type='primary'>Inactive</Button>
                        </div>
                    </div>
                </div>
